...
<li <?php if($url=='start'):?>class="active"<?php endif;?>><?php echo anchor('/doc/start','Get Start',array('data-toggle'=>'dropdown','data-target'=>'/doc/start')); ?></li>
<li <?php if($url=='api' || $class=='api'):?>class="active"<?php endif;?>><?php echo anchor('/doc/api','API设计',array('data-toggle'=>'dropdown','data-target'=>'/doc/api')); ?></li>
<li <?php if($url=='tool' || $class=='tool'):?>class="active"<?php endif;?>><?php echo anchor('/doc/tool','工具',array('data-toggle'=>'dropdown','data-target'=>'/doc/tool')); ?></li>
<li <?php if($url=='app' || $class=='app'):?>class="active"<?php endif;?>><?php echo anchor('/doc/app','PHP应用',array('data-toggle'=>'dropdown','data-target'=>'/doc/app')); ?></li>
