...
Zhao.Template简述: 通过CI SESSION库和Template机制，实现通用的提示设计，以及标准界面板块header-content-footer引用
</p>
<hr/>
<a href="https://raw.github.com/ftwbzhao/CIer-/master/application/controllers/yang.php" target="_blank" class="btn">ViewSource</a>
</div>
<!-- PHP引用用Pre代码块进行设计 -->
<p>PHP引用用Pre代码块进行设计，需要录入资源(css样式设计)，根据调用的栏位，返回设计代码块，提示设计，Header-conent-footer应用与设计</p>
