...
<li <?php if($url=='api' || $class=='api'):?>class="active"<?php endif;?>><?php echo anchor('/doc/api','API设计<span class="label label-info">4</span>',array('data-toggle'=>'dropdown','data-target'=>'/doc/api')); ?></li>
