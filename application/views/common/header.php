...
<li <?php if($url=='app' || $class=='app'):?>class="active"<?php endif;?>><?php echo anchor('/doc/app','PHP应用<span class="label label-success">5</span>',array('data-toggle'=>'dropdown','data-target'=>'/doc/app')); ?></li>
